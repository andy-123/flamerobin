...
const int DPBFb1::BUFFERINCR = 128;

void DPBFb1::Grow(int needed)
{
...
void DPBFb1::Insert(char type, const char* data)
{
...
void DPBFb1::Insert(char type, int16_t data)
{
	Grow(2 + 2);
    mBuffer[mSize++] = type;
...
void DPBFb1::Insert(char type, bool data)
{
	Grow(2 + 1);
    mBuffer[mSize++] = type;
...
void DPBFb1::Insert(char type, char data)
{
	Grow(2 + 1);
    mBuffer[mSize++] = type;
	mBuffer[mSize++] = char(1);
